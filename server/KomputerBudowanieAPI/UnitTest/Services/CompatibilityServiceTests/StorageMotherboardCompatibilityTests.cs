...
namespace Tests.Services.CompatibilityServiceTests
{
    public class StorageMotherboardCompatibilityTests
    {
        ...
        public async void Given_MotherboardAndStorage_When_CompatibilityCheck_Then_NotCompatible(Motherboard motherboard, List<Storage> storageList, List<string> problems)
        {
            // Arrange (Given)
        ...
        public async void Given_MotherboardAndStorage_When_CompatibilityCheck_Then_Compatible(Motherboard motherboard, List<Storage> storageList)
        {
            // Arrange (Given)
            PcConfiguration configuration = new PcConfiguration
            {
