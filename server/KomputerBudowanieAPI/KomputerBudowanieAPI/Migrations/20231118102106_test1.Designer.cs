...
namespace KomputerBudowanieAPI.Migrations
{
    ...
    [Migration("20231118102106_test1")]
    partial class test1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KomputerBudowanieAPI.Models.Comment", b =>
                {
            ...
            modelBuilder.Entity("PcConfigurationUser", b =>
                {
                    b.Property<Guid>("FavouriteConfigurationsId")
                        .HasColumnType("uuid");

                    b.Property<int>("UsersFavoritedId")
                        .HasColumnType("integer");

                    b.HasKey("FavouriteConfigurationsId", "UsersFavoritedId");

                    b.HasIndex("UsersFavoritedId");

                    b.ToTable("UserFavoriteConfigurations", (string)null);
                });
            ...
            modelBuilder.Entity("PcConfigurationUser", b =>
                {
                    b.HasOne("KomputerBudowanieAPI.Models.PcConfiguration", null)
                        .WithMany()
                        .HasForeignKey("FavouriteConfigurationsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KomputerBudowanieAPI.Models.User", null)
                        .WithMany()
