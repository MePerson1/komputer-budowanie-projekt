...
namespace KomputerBudowanieAPI.Migrations
{
    ...
    [Migration("20240102160633_isPrivateConfiguration")]
    partial class isPrivateConfiguration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KomputerBudowanieAPI.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("KomputerBudowanieAPI.Models.PcConfiguration", b =>
                {
                    ...
                    b.HasOne("KomputerBudowanieAPI.Models.ApplicationUser", "User")
                        .WithMany("Configurations")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("KomputerBudowanieAPI.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
