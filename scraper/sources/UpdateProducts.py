...
# Konwersja typowanego slownika na nietypowany, aby moc na nim swobodniej operowac
product_categories_and_links: dict = dict(product_categories_and_links)
...
if __name__ == "__main__":
    ...
    for category, link in database_categories_and_links.items():
        ...
        # Token jest odswiezany dla kazdej kategorii, aby przypadkiem nie wygasl podczas aktualizacji produktow
